...
public class Main {
    public static void main(String[] args) {
        ...
        //TODO delete
        clientService.deleteClient(createClient("Misha"));
        //TODO delete by id
        ...
        //TODO update
        clientService.updateClient(createClient(2L, "Vasily"));


        PlanetService planetService = new PlanetService();
        //TODO save
        planetService.savePlanet(createPlanet("QBDH1", "Vasily"));
        //TODO delete
        planetService.deletePlanet(createPlanet("36H80", "Jupiter"));
        //TODO delete by id
        planetService.deletePlanetById("17FOL");
        //TODO get by id
        System.out.println("clientService.findClientById(2L).getName() = " + planetService.findPlanetById("LKY15").getName());
        //TODO get all
        planetService.getAllPlanets().forEach(planet -> System.out.println(planet.getName()));
        //TODO update
        planetService.updatePlanet(createPlanet("LKY15", "Stepan"));
